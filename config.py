...
DYNAMIC_SYNTHETIC_WARMUP_EPOCHS = 0
...
CHECKPOINT_SELECTION_METRIC = "rmse"
CHECKPOINT_TAIL_MAE_LAMBDA = 0.0
...
SKIP_REDUNDANT_REAL_FORWARD = False
SKIP_REFRESH_DIAGNOSTICS = False

RGCN_BASIS_FACTORIZED = False

USE_SDPA = False
CACHE_POSITIONAL_ENCODING = False

COMPILE_PRETRAIN = False


FUSED_PRETRAIN_OPTIMIZER = False
